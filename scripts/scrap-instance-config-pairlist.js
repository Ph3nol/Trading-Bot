...
if (!process.env.TRADING_BOT_INSTANCE_CONFIG_PAIR) {
    console.log([])
...
(async () => {
    ...
    let scrapPayloadXPaths

    switch (process.env.TRADING_BOT_INSTANCE_CONFIG_PAIR) {
        case 'USDT':
            scrapPayloadXPaths = {
    ...
    console.log(JSON.stringify(pairsList))
